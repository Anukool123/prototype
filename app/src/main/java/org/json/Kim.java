            ...
            while (i < stringLength) {
                ...
                if (character <= TransportMediator.KEYCODE_MEDIA_PAUSE) {
                    ...
                    if (character >= 55296 && character <= 56319) {
                        i++;
                        character = (((character & 1023) << 10) | (string.charAt(i) & 1023)) + AccessibilityNodeInfoCompat.ACTION_CUT;
                    }
    ...
    public String toString() throws JSONException {
        if (this.string == null) {
            ...
            while (at < this.length) {
                ...
                if (c < AccessibilityNodeInfoCompat.ACTION_CUT) {
                    chars[length] = (char) c;
                    length++;
                } else {
                    chars[length] = (char) (55296 | ((c - AccessibilityNodeInfoCompat.ACTION_CUT) >>> 10));
                    length++;
