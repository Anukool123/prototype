...
public class JSONObject {
        ...
        while (true) {
            switch (x.nextClean()) {
                ...
                default:
                    ...
                    switch (x.nextClean()) {
                        case C0111R.styleable.View_minWidth /*44*/:
                        case C0111R.styleable.View_scaleY /*59*/:
                            if (x.nextClean() != '}') {
                                x.back();
                            } else {
                                return;
    ...
    public static String doubleToString(double d) {
        ...
        while (string.endsWith(Constants.VIA_RESULT_SUCCESS)) {
    ...
    public JSONObject increment(String key) throws JSONException {
        ...
        if (value == null) {
            ...
            put(key, (double) (((Float) value).floatValue() + DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        } else {
            ...
            for (int i = 0; i < len; i++) {
                ...
                switch (c) {
                    case TransportMediator.FLAG_KEY_MEDIA_PLAY_PAUSE /*8*/:
                        w.write("\\b");
                        break;
                    case SocializeConstants.PLATFORM_ID_WEIXIN_CIRCLE /*9*/:
                        w.write("\\t");
                        break;
                    case JSONzip.maxSubstringLength /*10*/:
                        w.write("\\n");
                        break;
                    case SocializeConstants.PLATFORM_ID_TWITTER /*12*/:
                        w.write("\\f");
                        break;
                    case SocializeConstants.PLATFORM_ID_GOOGLEPLUS /*13*/:
                        w.write("\\r");
                        break;
    ...
    public static Object wrap(Object object) {
        if (object == null) {
            ...
            String objectPackageName = objectPackage != null ? objectPackage.getName() : bq.f888b;
