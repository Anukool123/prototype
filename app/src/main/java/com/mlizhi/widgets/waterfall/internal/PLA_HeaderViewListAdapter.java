...
import com.mlizhi.widgets.waterfall.internal.PLA_ListView.FixedViewInfo;
...
public class PLA_HeaderViewListAdapter implements WrapperListAdapter, Filterable {
    ...
    public PLA_HeaderViewListAdapter(ArrayList<FixedViewInfo> headerViewInfos, ArrayList<FixedViewInfo> footerViewInfos, ListAdapter adapter) {
