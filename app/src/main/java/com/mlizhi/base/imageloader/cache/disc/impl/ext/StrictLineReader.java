...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: com.mlizhi.base.imageloader.cache.disc.impl.ext.StrictLineReader.1 */
    class C01211 extends ByteArrayOutputStream {
        C01211(int $anonymous0) {
            super($anonymous0);
        }
    ...
    public StrictLineReader(InputStream in, Charset charset) {
        this(in, AsyncHttpClient.DEFAULT_SOCKET_BUFFER_SIZE, charset);
    }
    ...
    public String readLine() throws IOException {
        ...
        synchronized (this.in) {
            ...
            ByteArrayOutputStream out = new C01211((this.end - this.pos) + 80);
            loop1:
            while (true) {
