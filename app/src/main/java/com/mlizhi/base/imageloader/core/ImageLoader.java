...
import com.mlizhi.base.imageloader.core.imageaware.NonViewAware;
...
import com.mlizhi.base.imageloader.core.listener.SimpleImageLoadingListener;
...
public class ImageLoader {
    ...
    public synchronized void init(ImageLoaderConfiguration configuration) {
        if (configuration == null) {
            ...
            C0126L.m33d(LOG_INIT_CONFIG, new Object[0]);
            this.engine = new ImageLoaderEngine(configuration);
            this.configuration = configuration;
        } else {
            C0126L.m38w(WARNING_RE_INIT_CONFIG, new Object[0]);
        }
    }
    ...
    public void displayImage(String uri, ImageAware imageAware, DisplayImageOptions options, ImageLoadingListener listener, ImageLoadingProgressListener progressListener) {
        ...
        C0126L.m33d(LOG_LOAD_IMAGE_FROM_MEMORY_CACHE, memoryCacheKey);
    ...
    public void destroy() {
        if (this.configuration != null) {
            C0126L.m33d(LOG_DESTROY, new Object[0]);
        }
        stop();
